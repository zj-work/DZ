...
namespace D.Extend
{
    public class Encryption
    {
        ...
        public string MD5Encrypt(string content)
        {
            ...
            byte[] encryData = md5.ComputeHash(bts);
            return Encoding.UTF8.GetString(encryData);
        }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public string Base64Decrypt(string data)
        {
